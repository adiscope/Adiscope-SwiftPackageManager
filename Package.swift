...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/adiscope/AdiscopeLuckyEvent-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaAdManager-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaAdMob-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaChartBoost-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaPangle-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaTnkPub-SwiftPackageManager.git", exact: "5.2.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaVungle-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMax-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterAdManager-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterAdMob-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterBidMachine-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterBigo-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterChartBoost-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterDTExchange-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterFan-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterInMobi-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterIronSource-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterLine-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterMobVista-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterMoloco-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterOgury-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterPangle-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterPubMatic-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterUnityAds-SwiftPackageManager.git", exact: "5.4.0"),
        .package(url: "https://github.com/adiscope/AdiscopeMediaMaxAdapterVungle-SwiftPackageManager.git", exact: "5.4.0"),
    ],
    targets: [
        .target(
            name: "AdiscopeTarget",
