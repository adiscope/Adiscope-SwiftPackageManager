...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Adiscope",
            url: "https://github.com/adiscope/Adiscope-iOS-Sample/releases/download/5.2.3/Adiscope.zip",
            checksum: "669b305c4abc981b8414b64ae2a4816c1d2d5258b24a04956fdf8085f9feeefc"
        ),
    ]
)
